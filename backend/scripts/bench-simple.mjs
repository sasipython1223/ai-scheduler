...
// Overall summary
const avgSLA = results.reduce((acc, r) => acc + r.slaCompliance, 0) / results.length;
...
console.log(`   Capacity safety: ${maxOveralloc === 0 ? '✅ PERFECT' : '⚠️  REVIEW'}`);
console.log(`   Performance grade: ${avgSLA >= 90 ? '🟢 EXCELLENT' : avgSLA >= 80 ? '🟡 GOOD' : '🔴 NEEDS WORK'}`);
